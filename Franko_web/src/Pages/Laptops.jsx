...
import { FunnelIcon, XMarkIcon, AdjustmentsHorizontalIcon, TagIcon , ComputerDesktopIcon} from "@heroicons/react/24/outline";
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {(filters.selectedBrand ? `${filters.selectedBrand} Laptops` : "Laptops")}

                        </h2>
                     
                      </div>
                      <p className="text-sm text-gray-500">
                      Explore powerful laptops and portable computing solutions
                        </p>
