...
const DigiLayout = ({ children }) => {
  ...
  const userName = user ? user.fullName : 'Social Media Manager';
  ...
  const menuItems = [
    ...
    { key: '/digi/orders', icon: ShoppingCart, label: 'Orders', link: '/digi/orders' },
    
    { key: '/digi/products', icon: Grid3X3, label: 'Products', link: '/digi/products' },
