...
const ShowroomProductsPage = () => {
  ...
  const selectedShowroom = useMemo(() => {
    return showrooms.find((s) => s.showRoomID === showRoomID);
  }, [showrooms, showRoomID]);

  const products = useMemo(() => {
    const showroomProducts = productsByShowroom[showRoomID] || [];
  ...
  const filteredProducts = useMemo(() => {
    return products.filter((product) => {
      const { priceRange, showDiscountedOnly } = filters;
      const matchesPrice =
      ...
      <div className="bg-gradient-to-br from-red-50 to-orange-50 p-6 rounded-2xl border border-red-100">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-gradient-to-br from-red-400 to-orange-400 rounded-lg">
      ...
      {availableShowrooms.length > 0 && (
        <div className="bg-gradient-to-br from-green-50 to-indigo-50 p-6 rounded-2xl border border-green-100">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h4 className="text-base font-semibold text-gray-800">Other Showrooms</h4>
          </div>
        ...
        <div className="md:hidden flex justify-between items-center mb-6 bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <BuildingStorefrontIcon className="w-5 h-5 text-red-300" />
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        <div className="p-2 bg-white">
                          <BuildingStorefrontIcon className="w-6 h-6 text-red-300" />
                        </div>
                      ...
                      <p className="text-gray-500 text-sm">
                        Discover products from this showroom
                      </p>
                    </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12">
                <div className="flex flex-col justify-center items-center text-center space-y-6">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-green-500 to-teal-600 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                  >
                    Reset Filters
                  </button>
                </div>
