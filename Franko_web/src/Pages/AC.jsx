...
import { FunnelIcon, XMarkIcon, AdjustmentsHorizontalIcon, TagIcon, Square3Stack3DIcon } from "@heroicons/react/24/outline";
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {(filters.selectedBrand ? `${filters.selectedBrand} ` : "Air-Conditioners")}

                        </h2>
                     
                      </div>
                      <p className="text-sm text-gray-500">
                      Explore essential air-Conditioners and modern household solutions
                        </p>
