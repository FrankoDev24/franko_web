...
const categoryId = "db54033b-e95d-4a6c-8744-45e4d462c19e";
    ...
    <>
      <style>{`
        ...
        .ac-page-header-accent {
          ...
          background: var(--ac-green); flex-shrink: 0;
        }
        ...
        .ac-page-count {
          font-size: 13px; font-weight: 500; color: var(--ac-light); margin-top: 2px;
        }

        .ac-page-header-line {
          flex: 1; height: 1px; background: var(--ac-border); display: none;
        }
        ...
        .ac-desktop-sort-btn {
          ...
          color: var(--ac-mid); cursor: pointer; transition: all 0.15s;
          font-family: var(--ac-font);
        }
        .ac-desktop-sort-btn:hover {
          border-color: var(--ac-green-accent); color: var(--ac-dark);
        }
        ...
        .ac-filter-header-text {
          font-size: 16px; font-weight: 800; color: var(--ac-dark); letter-spacing: -0.01em;
        }

        .ac-filter-section {
          padding: 16px; background: #fff; border: 1px solid var(--ac-border);
          border-radius: var(--ac-radius);
        }
        ...
        .ac-price-symbol {
          position: absolute; left: 10px; font-size: 13px; font-weight: 600; color: var(--ac-light);
        }
        .ac-price-input {
          width: 100%; padding: 8px 10px 8px 24px; border: 1px solid var(--ac-border);
          border-radius: var(--ac-radius); font-size: 13px; font-weight: 500;
          color: var(--ac-dark); font-family: var(--ac-font);
          transition: border-color 0.15s; outline: none;
        }
        .ac-price-input:focus {
          border-color: var(--ac-green-accent);
        ...
        .ac-brand-tag:hover {
          border-color: var(--ac-green-accent); color: var(--ac-green);
        ...
        .ac-drawer-close {
          ...
          border-radius: var(--ac-radius); background: #fff; cursor: pointer;
        ...
        .ac-card-badge-discount {
          right: 8px; background: var(--ac-red); color: #fff;
        ...
        .ac-skeleton {
          border: 1px solid #eee; border-radius: var(--ac-radius);
        ...
        .ac-empty-title {
          font-size: 18px; font-weight: 700; color: var(--ac-dark); margin-bottom: 8px;
        }

        .ac-empty-desc {
          font-size: 14px; color: var(--ac-light); max-width: 360px;
      ...
      <div className="ac-root min-h-screen">
        <Helmet>
          <title>Buy Air Conditioners Online - Best Prices in Ghana | Franko Trading</title>
          <meta name="description" content="Explore the best air conditioners in Ghana. Find top brands at affordable prices and enjoy fast delivery." />
          <meta name="keywords" content="Air Conditioners, Buy AC Online, Best AC Brands in Ghana, Affordable Air Conditioners" />
          <meta property="og:title" content="Buy Air Conditioners Online - Best Prices in Ghana" />
          ...
          <script type="application/ld+json">
            {JSON.stringify({
              ...
              "description": "Shop high-quality air conditioners from top brands.",
              "url": "https://www.frankotrading.com/air-condition",
          ...
          <div className="ac-page-header">
            ...
            <div>
              <h1 className="ac-page-title">
                {selectedBrand ? `${selectedBrand} Air Conditioners` : "Air Conditioners"}
              </h1>
              ...
              {trulyEmpty && (
                <div className="ac-empty">
                  ...
                  <div className="ac-empty-title">
                    {isFiltersActive ? "No matching air conditioners" : "No air conditioners available"}
                  </div>
                  <div className="ac-empty-desc">
                    {isFiltersActive
                      ? "Try adjusting your price range, brand, or filters to find what you're looking for."
                      : "We don't have any air conditioners available at the moment. Please check back later or explore other categories."}
                  </div>
