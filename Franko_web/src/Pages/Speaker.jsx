          ...
          <div className="sp-brand-tags">
            {brands.map((brand) => (
              <button
                ...
                className={`sp-brand-tag ${selectedBrand === brand ? "sp-brand-tag-active" : ""}`}
              >
                {brand}
              </button>
            ))}
    ...
    <>
      <style>{`
        ...
        .sp-notif {
          ...
          border-radius: var(--sp-radius); min-width: 280px;
        ...
        .sp-brand-tags { display: flex; flex-wrap: wrap; gap: 6px; }
        .sp-brand-tag {
          ...
          <div className="sp-page-header">
            ...
            <div>
              <h1 className="sp-page-title">
                {selectedBrand ? `${selectedBrand} Speakers` : "Speakers"}
              </h1>
              ...
              {trulyEmpty && (
                <div className="sp-empty">
                  ...
                  <div className="sp-empty-title">
                    {isFiltersActive ? "No matching speakers" : "No speakers available"}
                  </div>
                  <div className="sp-empty-desc">
                    {isFiltersActive
                      ? "Try adjusting your price range, brand, or filters to find what you're looking for."
                      : "We don't have any speakers available at the moment. Please check back later or explore other categories."}
                  </div>
