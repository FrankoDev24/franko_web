 ...
 const renderFilterContent = () => (
  ...
  <div className="flex items-center gap-1 ">
    ...
    <h6 className="text-md font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
      {filters.selectedBrand || "Home Appliances"}
    </h6>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {(filters.selectedBrand ? `${filters.selectedBrand} ` : "Home Appliances")}

                        </h2>
                     
                      </div>
                      <p className="text-sm text-gray-500">
                      Explore essential home appliances and modern household solutions
                        </p>
